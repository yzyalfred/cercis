...
func ByteToUin16(buf []byte, littleEndian bool) uint16 {
	if littleEndian {
...
func ByteToUin32(buf []byte, littleEndian bool) uint32 {
	if littleEndian {
...
func ByteToUin64(buf []byte, littleEndian bool) uint64 {
	if littleEndian {
